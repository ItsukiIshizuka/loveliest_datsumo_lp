        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href={LINE_URL}
                className="btn-cta flex items-center justify-center gap-2 bg-[#06C755] text-white font-body font-medium text-sm px-5 py-3 rounded-full hover:bg-[#05b34d]"
                aria-label="LINEで予約する"
              >
                <span className="font-bold text-base leading-none" aria-hidden>L</span>
                LINEで予約する
              </a>
